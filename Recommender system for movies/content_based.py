...
for i in books.Book_Lab:
    print(i,'book of ',len(books.Book_Lab),'books')
...
#%%
print('Write the name of Author or Publisher that you prefere ')
text=input().lower()
# Remove the punctuation's sign  
for p in punctuation:
    text=text.replace(p,' ')
...
listaurl_CB=sample_book_rac_CB['Image-URL-L'].values
lb.Print_Book_Rac(listaurl_CB)
